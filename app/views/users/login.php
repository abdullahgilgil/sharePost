<?php require APPROOT . '/views/inc/header.php'; ?>
   ...
   <div class="row">
      <div class="col-md-6 mx-auto">
         ...
         <?php flash('register_success_msg'); ?>
         <?php flash('login_email_error'); ?>
         <?php flash('login_password_error'); ?>
            ...
            <form action="<?php echo URLROOT; ?>/users/login" method="POST">
               ...
               <div class="form-group">
                  <label for="password">Password: <strong><sup>*</sup></strong></label>
                  <input type="password" name="password" class="form-control form-control-lg <?php echo (!empty($data['password_err'])) ? 'is-invalid' : ''; ?>" value="<?php  ?>">
               ...
               <div class="row">
                  <div class="col mt-4">
                     <a href="<?php echo URLROOT; ?>/users/forgot" class="btn btn-light btn-block">Forgot Password ?</a>
                  </div>
               </div>
